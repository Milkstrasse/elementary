...
let exampleWitch: Witch = Witch(data: WitchData(name: "luna", element: "water", spells: ["unknownSpell"], base: Base(health: 100, attack: 100, defense: 100, agility: 100, precision: 0, resistance: 100)))
