        ...
        ScrollViewReader { value in
            VStack(spacing: 5) {
                Button(action: {
                    ...
                    DetailedActionView(title: "spells", description: "spellsDescr", symbol: "0xf6de")
                }
                ...
                Button(action: {
                    ...
                    DetailedActionView(title: "coven", description: "covenDescr", symbol: "0xf500")
                }
                ...
                Button(action: {
                    ...
                    DetailedActionView(title: "forfeit", description: "forfeitDescr", symbol: "0xf70c")
                }
...
struct OptionsView_Previews: PreviewProvider {
    static var previews: some View {
        OptionsView(currentSection:Binding.constant(.options), gameOver:Binding.constant(false), fightLogic: FightLogic(players: [Player(id: 0, witches: [exampleWitch]), Player(id: 1, witches: [exampleWitch])]), player: Player(id: 1, witches: [exampleWitch]))
    }
}
