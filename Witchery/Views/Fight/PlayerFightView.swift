            ...
            ZStack(alignment: .bottomTrailing) {
                ...
                VStack {
                    ...
                    ZStack(alignment: .top) {
                        ...
                        .padding(.horizontal, 15).opacity(fightLogic.battling ? 0.7 : 1.0).disabled(fightLogic.battling)
                    }
                    .frame(height: 175 + (player.id == 0 ? geometry.safeAreaInsets.top : geometry.safeAreaInsets.bottom)).offset(y: player.id == 0 ? geometry.safeAreaInsets.top : geometry.safeAreaInsets.bottom)
                }
            }
...
struct PlayerFightView_Previews: PreviewProvider {
    static var previews: some View {
        PlayerFightView(fightLogic: FightLogic(players: [Player(id: 0, witches: [exampleWitch]), Player(id: 1, witches: [exampleWitch])]), player: Player(id: 1, witches: [exampleWitch]), offsetX: 0, gameOver:Binding.constant(false), isInteractable: true)
    }
}
