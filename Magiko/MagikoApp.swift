...
let exampleFighter: Fighter = Fighter(data: FighterData(name: "Koko", element: "Water", skills: [], base: Base(health: 100, attack: 100, defense: 100, agility: 100, precision: 100, spAttack: 100)))
