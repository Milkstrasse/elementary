                                        ...
                                        ZStack(alignment: .topTrailing) {
                                            ...
                                            VStack(spacing: 0) {
                                                HStack {
                                                    ...
                                                    Spacer()
                                                    CustomText(key: "\(Int(fightLogic.getFighter(player: 1).currhp))/\(Int(fightLogic.getFighter(player: 1).base.health))HP")
                                                }
                                                ZStack(alignment: .leading) {
                                                    Rectangle().fill(Color.purple).frame(height: 6)
                                                    Rectangle().fill(Color.yellow).frame(width: calcWidth(fighter: fightLogic.getFighter(player: 1)), height: 6)
                                                }
                                            }
