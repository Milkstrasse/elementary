...
let exampleFighter: Fighter = Fighter(data: FighterData(name: "example", title: "placeholder", element: "water", base: Base(health: 65, attack: 100, defense: 80, agility: 50, precision: 90, resistance: 55), spells: ["waterSimpleAttack", "woodSimpleAttack", "decaySimpleAttack", "attackDown"], skins: [""]))
