...
struct OptionsView_Previews: PreviewProvider {
    static var previews: some View {
        OptionsView(currentSection:Binding.constant(.options), gameOver:Binding.constant(false), fightLogic: FightLogic(players: [Player(id: 0, fighters: [waterFighter]), Player(id: 1, fighters: [waterFighter])]), player: Player(id: 1, fighters: [waterFighter]))
    }
}
