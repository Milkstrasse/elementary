...
struct PlayerFightView_Previews: PreviewProvider {
    static var previews: some View {
        ZStack {
            PlayerFightView(fightLogic: FightLogic(players: [Player(id: 0, fighters: [waterFighter]), Player(id: 1, fighters: [waterFighter])]), player: Player(id: 1, fighters: [waterFighter]), gameOver: Binding.constant(false), isGameOver: false, fightOver: Binding.constant(false), isInteractable: true)
        }
    }
}
